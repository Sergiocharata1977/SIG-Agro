...
/**
 * Modal para registrar una nueva labor agrícola en un lote
 */
...
export default function NuevaLaborModal({
    ...
    // Para fertilización/pulverización
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Construir descripción automática si está vacía
            ...
            const evento = {
                loteId,
                campaniaId: '', // TODO: Seleccionar campaña
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                ...
                                placeholder="Total del lote si vacío"
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                placeholder="Automática si vacía"
                            />
                        </div>
                    </div>
                    ...
                    <details className="border rounded-lg">
                        <summary className="p-3 cursor-pointer bg-gray-50 rounded-t-lg">
                            🌡️ Condiciones Climáticas (opcional)
                        </summary>
