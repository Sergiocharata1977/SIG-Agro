                        ...
                        if (!item.subItems) {
                            return (
                                <Link
                                    ...
                                    href={item.href}
                                    onClick={() => setMobileOpen(false)}
                                    className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition ${item.active
                        ...
                        return (
                            <div key={item.href}>
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition ${item.active
