...
export const MAPA_GIS_MANIFEST: AgroPluginManifest = {
  identity: {
    plugin_id: 'sig-agro-mapa-gis',
    slug: 'mapa_gis',
    display_name: 'Mapa GIS',
    summary: 'Visualización cartográfica de campos y lotes con capas satelitales e índices productivos.',
    category: 'campo_gis',
    tier: 'base',
    visibility: 'internal',
    maturity: 'ga',
  ...
  compatibility: {
    ...
    optional_capabilities: ['sig-agro-campos', 'sig-agro-ia'],
  ...
  tenant_settings: {
    ...
    required: false,
    defaults: { capa_base: 'satellite', zoom_default: 13 },
    schema: {},
  },
  routes: {
    navigation: [
      { path: '/campos', label: 'Mapa GIS', icon: 'Map', requiredPermissions: ['mapa_gis:read'] },
    ],
    pages: [],
  },
  events: { emits: [], consumes: [] },
  billing: { model: 'plan_included', feature_flag: 'mapa_gis' },
