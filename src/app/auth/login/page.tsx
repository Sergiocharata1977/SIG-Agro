  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#071a13] text-white">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(178,247,70,0.18),transparent_24%),linear-gradient(135deg,rgba(1,45,29,0.94),rgba(7,26,19,0.82))]" />
      </div>
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-12 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.92fr] lg:px-8">
        <section className="max-w-2xl">
          ...
          <h1 className="mt-6 text-4xl font-semibold leading-tight sm:text-5xl">
            Precision stewardship para una operacion agro mas clara y trazable.
          </h1>
          <p className="mt-5 max-w-xl text-lg leading-8 text-white/72">
            Accede a campañas, campos, contabilidad y decisiones de manejo desde una sola cabina de control.
          </p>

          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {[
              'Mapas satelitales activos',
              'Cuaderno y operaciones trazables',
              'Libro diario y rentabilidad',
            ].map((item) => (
              <div key={item} className="rounded-[24px] border border-white/10 bg-white/5 px-4 py-4 text-sm text-white/82 backdrop-blur-sm">
                {item}
              </div>
            ))}
          </div>
        ...
        <section className="rounded-[36px] border border-white/10 bg-white/95 p-8 text-slate-900 shadow-2xl shadow-black/20 backdrop-blur-sm sm:p-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Ingresá con tu cuenta productiva para retomar la operación.</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <label className="block space-y-2">
              <span className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">Email address</span>
              <input
                type="email"
                value={email}
            ...
            <label className="block space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#446900]">
                  Forgot password
                </button>
              </div>
            ...
            <label className="flex items-center gap-3 text-sm text-slate-500">
              <input type="checkbox" className="h-4 w-4 rounded border-slate-300 text-emerald-700 focus:ring-emerald-500" />
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#012d1d] px-5 py-4 text-sm font-semibold text-white transition hover:bg-[#1b4332] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {loading ? 'Ingresando...' : 'Secure login'}
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-400">or continue with</span>
            <div className="h-px flex-1 bg-slate-200" />
          </div>

          <div className="grid gap-3 sm:grid-cols-2">
            <button type="button" className="rounded-2xl border border-slate-200 px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50">
              Google
            </button>
            <button type="button" className="rounded-2xl border border-slate-200 px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50">
              Microsoft
